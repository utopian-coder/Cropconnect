    ...
    <div>
      <section>
        <div class='py-8 px-4 mx-auto max-w-screen-xl lg:py-16'>
          <div class='bg-purple-200 border border-gray-200  rounded-lg p-8 md:p-12 mb-8'>
            <h1 class='heading'>Our Goals</h1>
            <p class='text-lg font-normal text-gray-900 mb-6'>
              Lorem ipsum dolor sit amet, consectetur adipisicing eli Lorem,
              ipsum dolor sit amet consectetur adipisicing elit. Nisi vel in
              error non odit harum dolorum iure repudiandae veniam numquam! t.
              Voluptas, ex?
            </p>
          </div>
          <div class='grid md:grid-cols-2 gap-8'>
            <div class='bg-orange-200 border border-gray-200  rounded-lg p-8 md:p-12'>
              <a
                href='#'
              ...
              <p class='text-lg font-normal text-gray-900  mb-4'>
                ...
                Repudiandae amet laboriosam inventore commodi ullam sunt
                aspernatur voluptas nam obcaecati consequatur?
              </p>
              <a
                href='#'
            ...
            <div class='bg-green-200  border border-gray-200  rounded-lg p-8 md:p-12'>
              <a
                href='#'
                class='bg-green-100 text-green-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded-md dark:bg-gray-700 dark:text-green-400 mb-2'
              >
              ...
              <p class='text-lg font-normal text-gray-500mb-4'>
